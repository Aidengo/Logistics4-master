...
public class ItemController {
    ...
    public String addItem(@RequestParam(value = "itemname") String itemname,@RequestParam(value = "number") int number
            ,@RequestParam(value = "ref") int ref,@RequestParam("warehousename") String warehousename,@RequestParam(value = "commonCarrier") String commonCarrier){
        int i = itemService.addItem(itemname, number,ref,warehousename,commonCarrier);
        if(i<=0){
            return "fail";
        }
        return "homepage";
