...
public interface CourierMapper {
    ...
    @Insert("insert into courier values (null,#{name},#{sex},#{age},#{address},#{phonenumber})")
    int addCourier(@Param("name") String name,@Param("sex")String sex ,@Param("age")Integer age
    ...
    int updateCourierInfo(@Param("newname") String newname,@Param("sex")  String sex,@Param("address") String address
            ,@Param("age")  int age, @Param("phonenumber") String phonenumber,@Param("name") String name);
}
