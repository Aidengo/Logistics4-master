...
public class WarehouseServiceImpl implements WarehouseService {
    ...
    @Override
    public int addWarehouse(String area, String name,String wareHouseType, int size, String linkman, String phonenumber ) {
        return warehouseMapper.addWarehouse(area,name,wareHouseType,size,linkman,phonenumber);
    }
