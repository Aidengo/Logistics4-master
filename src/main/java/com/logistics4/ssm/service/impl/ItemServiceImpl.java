...
public class ItemServiceImpl implements ItemService {
    ...
    @Override
    public int addItem(String itemname, int number,int ref,String warehousename,String commonCarrier) {
        return itemMapper.addItem(itemname,number,ref,warehousename,commonCarrier);
    }
